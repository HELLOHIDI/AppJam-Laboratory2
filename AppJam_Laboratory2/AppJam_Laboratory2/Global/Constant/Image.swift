...
public enum Image {
    ...
    static let friendProfileImage4 = UIImage(named: "friend_profile4")!
    static let friendProfileImage5 = UIImage(named: "friend_profile5")!
    static let friendProfileImage6 = UIImage(named: "friend_profile6")!
